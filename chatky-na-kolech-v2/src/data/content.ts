...
export const process = [
  {
    n: "01",
    title: "Rozhovor",
    text: "Co má prostor umožnit, kde bude stát a jaký je váš rámcový rozpočet? Nejdřív si ujasníme to podstatné.",
  },
  {
    n: "02",
    title: "Návrh",
    text: "Rozměry, dispozice, materiály a výbava dostanou konkrétní podobu i cenový rámec.",
  },
  {
    n: "03",
    title: "Výroba",
    text: "Dům vzniká v dílně pod jednou střechou. Průběžně vidíte, jak roste, a máte prostor doladit detaily.",
  },
  {
    n: "04",
    title: "Cesta domů",
    text: "Zajistíme domluvený převoz, dokumentaci i předání. Vy už řešíte první noc, hosta nebo otevření sezony.",
  },
];
...
export const values = [
  {
    title: "Materiál, který stárne dobře",
    text: "Přirozené dřevo, matný kov a odolné povrchy volíme tak, aby získávaly charakter, ne únavu.",
  },
  {
    title: "Pohyb jako součást návrhu",
    text: "Podvozek, rozložení hmotnosti a převoz řešíme od začátku. Ne až ve chvíli, kdy má dům vyjet.",
  },
  {
    title: "Jedna zakázka, jeden celek",
    text: "Dispozice, fasáda i interiér vznikají spolu. Díky tomu dům nepůsobí jako seznam příplatků.",
  },
];
