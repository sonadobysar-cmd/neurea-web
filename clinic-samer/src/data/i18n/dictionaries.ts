...
const cs: Dictionary = {
  meta: {
    title: "MUDr. Samer Asad · Gynekologie a reprodukční medicína, Praha 4",
    description:
      "Osobní gynekologická péče v Praze 4. Prevence, neplodnost, těhotenství a moderní diagnostika — s časem na vaše otázky.",
  },
  brand: {
  ...
  trust: {
    ...
    languagesText: "Česky, anglicky, německy, italsky a arabsky.",
  ...
  services: {
    eyebrow: "Služby",
    title: "Péče podle vaší situace",
    lead: "Od prevence přes těhotenství až po řešení neplodnosti — jeden lékař, kontinuita péče a prostor na otázky.",
    viewAll: "Všechny služby",
    items: [
      {
        id: "pregnancy",
        title: "Těhotenská poradna a ultrazvuk",
        text: "Pravidelné kontroly, ultrazvuk zpravidla každé tři týdny a doporučená genetická vyšetření podle fáze těhotenství.",
      },
      {
        id: "gyn",
        title: "Ambulantní gynekologie",
        text: "Preventivní prohlídky, pravidelné kontroly a řešení akutních i dlouhodobých gynekologických obtíží.",
      },
      {
        id: "fertility",
        title: "Neplodnost u párů",
        text: "Citlivá diagnostika ženy i muže, vyhodnocení výsledků a společný návrh dalšího postupu.",
      },
      {
        id: "contraception",
        title: "Hormonální a nehormonální tělíska",
        text: "Výběr vhodné varianty včetně Levosertu podle zdravotního stavu, věku a plánování rodiny.",
      },
      {
        id: "hormones",
        title: "Hormonální potíže",
        text: "Diagnostika a léčba obtíží, které ovlivňují cyklus, plodnost i každodenní kvalitu života.",
      },
      {
        id: "metabolism",
      ...
      {
        id: "laser",
        title: "CO₂ laserová gynekologie",
        text: "Šetrné ošetření změn po porodu, chronických obtíží a lehkého stupně inkontinence po individuálním posouzení lékařem.",
      },
    ],
  },
  about: {
...
const en: Dictionary = {
  meta: {
    ...
    description:
      "Discreet gynaecology and IVF in Prague 4. Prevention, fertility, pregnancy care — in Czech, English, German, Italian and Arabic.",
  },
  brand: {
    name: "MUDr. Samer Asad",
    short: "Clinic Samer",
  ...
  trust: {
    ...
    languagesText: "Czech, English, German, Italian and Arabic.",
  ...
  services: {
    ...
    lead: "From prevention and pregnancy to fertility care — one doctor, continuous care and time for your questions.",
    viewAll: "All services",
    items: [
      {
        id: "pregnancy",
        title: "Pregnancy clinic & ultrasound",
        text: "Regular check-ups, ultrasound usually every three weeks and recommended genetic screening for each stage of pregnancy.",
      },
      {
        id: "gyn",
        title: "Outpatient gynaecology",
        text: "Preventive visits, regular check-ups and care for acute or long-term gynaecological concerns.",
      },
      {
        id: "fertility",
        title: "Couple infertility",
        text: "Sensitive assessment of both partners, explanation of results and a shared plan for the next steps.",
      },
      {
        id: "contraception",
        title: "Hormonal & non-hormonal IUDs",
        text: "Choosing the right option, including Levosert, based on health, age and family planning.",
      },
      {
        id: "hormones",
      ...
      {
        id: "laser",
        title: "CO₂ laser gynaecology",
        text: "Gentle treatment for postpartum changes, chronic concerns and mild incontinence after an individual medical assessment.",
      },
    ],
  },
  about: {
...
const de: Dictionary = {
  meta: {
    ...
    description:
      "Diskrete Gynäkologie und IVF in Prag 4. Vorsorge, Fruchtbarkeit, Schwangerschaft — auf Tschechisch, Englisch, Deutsch, Italienisch und Arabisch.",
  },
  brand: {
    name: "MUDr. Samer Asad",
    short: "Clinic Samer",
  ...
  trust: {
    ...
    languagesText: "Tschechisch, Englisch, Deutsch, Italienisch und Arabisch.",
  ...
  services: {
    eyebrow: "Leistungen",
    title: "Betreuung für jede Situation",
    lead: "Von Vorsorge und Schwangerschaft bis zum Kinderwunsch — ein Arzt, kontinuierliche Betreuung und Zeit für Fragen.",
    ...
    items: [
      ...
      },
      {
        ...
        text: "Vorsorge, regelmäßige Kontrollen sowie Behandlung akuter und langfristiger gynäkologischer Beschwerden.",
      },
      {
        id: "fertility",
        title: "Unfruchtbarkeit bei Paaren",
        text: "Einfühlsame Diagnostik beider Partner, verständliche Ergebnisse und ein gemeinsamer Plan für die nächsten Schritte.",
      },
      {
        id: "contraception",
        title: "Hormonelle & hormonfreie Spiralen",
        text: "Auswahl der passenden Variante einschließlich Levosert nach Gesundheit, Alter und Familienplanung.",
      },
      {
        id: "hormones",
      ...
      {
        id: "laser",
        title: "CO₂-Lasergynäkologie",
        text: "Schonende Behandlung nach der Geburt, bei chronischen Beschwerden und leichter Inkontinenz nach ärztlicher Beurteilung.",
      },
    ],
  },
  about: {
...
const it: Dictionary = {
  meta: {
    ...
    description:
      "Ginecologia discreta e IVF a Praga 4. Prevenzione, fertilità, gravidanza — in ceco, inglese, tedesco, italiano e arabo.",
  },
  brand: {
    name: "MUDr. Samer Asad",
    short: "Clinic Samer",
  ...
  trust: {
    languages: "Cinque lingue",
    languagesText: "Ceco, inglese, tedesco, italiano e arabo.",
  ...
  services: {
    eyebrow: "Servizi",
    title: "Cure per ogni situazione",
    lead: "Dalla prevenzione e gravidanza alla fertilità — un medico, continuità di cura e tempo per le domande.",
    ...
    items: [
      ...
      },
      {
        ...
        text: "Visite preventive, controlli regolari e cura dei disturbi ginecologici acuti o persistenti.",
      },
      {
        id: "fertility",
        title: "Infertilità di coppia",
        text: "Valutazione sensibile di entrambi i partner, spiegazione dei risultati e piano condiviso per i passi successivi.",
      },
      {
        id: "contraception",
        title: "IUD ormonali e non ormonali",
        text: "Scelta della soluzione adatta, compreso Levosert, in base a salute, età e pianificazione familiare.",
      },
      {
        id: "hormones",
      ...
      {
        id: "laser",
        title: "Ginecologia laser CO₂",
        text: "Trattamento delicato dei cambiamenti post-parto, disturbi cronici e incontinenza lieve dopo valutazione medica.",
      },
    ],
  },
  about: {
...
const ar: Dictionary = {
  meta: {
    ...
    description:
      "رعاية نسائية سرية وأطفال أنابيب في براغ 4. الوقاية والخصوبة والحمل — بالتشيكية والإنجليزية والألمانية والإيطالية والعربية.",
  },
  brand: {
  ...
  trust: {
    languages: "خمس لغات",
    languagesText: "التشيكية والإنجليزية والألمانية والإيطالية والعربية.",
  ...
  services: {
    eyebrow: "الخدمات",
    title: "رعاية تناسب كل مرحلة",
    lead: "من الوقاية والحمل إلى علاج الخصوبة — طبيب واحد ورعاية مستمرة ووقت لأسئلتكن.",
    viewAll: "كل الخدمات",
    items: [
      {
        id: "pregnancy",
      ...
      },
      {
        ...
        text: "زيارات وقائية وفحوصات منتظمة وعلاج المشكلات النسائية الحادة أو المستمرة.",
      },
      {
        id: "fertility",
        title: "العقم لدى الأزواج",
        text: "تقييم حساس لكلا الشريكين وشرح النتائج ووضع خطة مشتركة للخطوات التالية.",
      },
      {
        id: "contraception",
        title: "اللوالب الهرمونية وغير الهرمونية",
        text: "اختيار الخيار المناسب بما فيه Levosert حسب الصحة والعمر وخطط الأسرة.",
      },
      {
        id: "hormones",
      ...
      {
        id: "laser",
        title: "طب النساء بليزر CO₂",
        text: "علاج لطيف لتغيرات ما بعد الولادة والمشكلات المزمنة والسلس الخفيف بعد تقييم الطبيب.",
      },
    ],
  },
  about: {
