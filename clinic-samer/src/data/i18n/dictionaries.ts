...
const cs: Dictionary = {
  meta: {
    ...
    description:
      "Diskrétní gynekologická péče a IVF v Praze 4. Prevence, neplodnost, těhotenství — v češtině, angličtině, němčině, italštině a arabštině.",
  },
  brand: {
  ...
  services: {
    ...
    items: [
      ...
      {
        id: "lbc",
        title: "Moderní cytologie LBC",
        text: "Spolehlivé vyšetření buněk děložního čípku odběrem do tekutého média.",
      },
      {
        id: "contraception",
        title: "Antikoncepce bez hormonů",
        text: "Nitroděložní tělísko GyneFix® pro dlouhodobou ochranu bez hormonů.",
      },
      {
        id: "incontinence",
        title: "Inkontinence & endokrinologie",
        text: "Posílení pánevního dna, genetické testování a léčba hormonálních poruch.",
      },
    ],
  },
  about: {
    ...
    nurseTitle: "Bc. Lilija Symkanynec, DiS.",
  ...
  booking: {
    ...
    lead: "Pošlete preferovaný čas — ozveme se s potvrzením nebo nabídkou alternativy.",
...
const en: Dictionary = {
  ...
  services: {
    ...
    items: [
      ...
      {
        id: "lbc",
        title: "Modern LBC cytology",
        text: "Reliable cervical cell testing with liquid-based cytology.",
      },
      {
        id: "contraception",
        title: "Hormone-free contraception",
        text: "GyneFix® IUD for long-term contraception without hormones.",
      },
      {
        id: "incontinence",
        title: "Incontinence & endocrinology",
        text: "Pelvic floor support, genetic testing and hormonal disorder care.",
      },
    ],
  },
  about: {
  ...
  booking: {
    eyebrow: "Booking",
    title: "Choose a time",
    lead: "Share your preferred slot — we will confirm or suggest an alternative.",
    name: "Full name",
    email: "Email",
    phone: "Phone",
    service: "Visit type",
...
const de: Dictionary = {
  ...
  services: {
    ...
    items: [
      ...
      {
        id: "lbc",
        title: "Moderne LBC-Zytologie",
        text: "Zuverlässige Zervixzytologie mit Flüssigmedium.",
      },
      {
        id: "contraception",
        title: "Hormonfreie Verhütung",
        text: "GyneFix®-Spirale für langfristigen Schutz ohne Hormone.",
      },
      {
        id: "incontinence",
        title: "Inkontinenz & Endokrinologie",
        text: "Beckenbodentraining, Gentests und Behandlung hormoneller Störungen.",
      },
    ],
  },
  about: {
  ...
  booking: {
    eyebrow: "Termin",
    title: "Zeit wählen",
    lead: "Teilen Sie Ihren Wunschtermin — wir bestätigen oder schlagen eine Alternative vor.",
...
const it: Dictionary = {
  ...
  services: {
    ...
    items: [
      ...
      {
        id: "lbc",
        title: "Citologia moderna LBC",
        text: "Esame affidabile delle cellule cervicali con citologia in liquido.",
      },
      {
        id: "contraception",
        title: "Contraccezione senza ormoni",
        text: "IUD GyneFix® per protezione a lungo termine senza ormoni.",
      },
      {
        id: "incontinence",
        title: "Incontinenza & endocrinologia",
        text: "Pavimento pelvico, test genetici e cura dei disturbi ormonali.",
      },
    ],
  },
  about: {
  ...
  booking: {
    ...
    lead: "Indica la fascia preferita — confermeremo o proporremo un’alternativa.",
    name: "Nome e cognome",
    email: "Email",
    phone: "Telefono",
...
const ar: Dictionary = {
  ...
  services: {
    ...
    items: [
      ...
      {
        id: "lbc",
        title: "فحص الخلايا الحديث LBC",
        text: "فحص موثوق لخلايا عنق الرحم بالوسط السائل.",
      },
      {
        id: "contraception",
        title: "منع حمل بلا هرمونات",
        text: "لوالب GyneFix® للحماية طويلة الأمد بلا هرمونات.",
      },
      {
        id: "incontinence",
        title: "سلس البول والغدد الصماء",
        text: "تقوية قاع الحوض والفحوصات الجينية وعلاج الاضطرابات الهرمونية.",
      },
    ],
  },
  about: {
  ...
  booking: {
    eyebrow: "الحجز",
    title: "اختاري وقتاً",
    lead: "أرسلي الوقت المفضل — نؤكد أو نقترح بديلاً.",
    name: "الاسم الكامل",
