export const luxuryBodyHtml = `<div id="glow" aria-hidden="true"></div>
...
<nav>
  <div class="wrap nav-in">
    ...
    <div class="nav-links">
      <a href="#disciplina">Disciplíny</a>
      <a href="#program">Průběh</a>
      <a href="#galerie">Galerie</a>
      <a href="#kouzlo">Kouzlo</a>
      <a href="#cena">Cena</a>
      <a href="#robin">O Robinovi</a>
    </div>
    <a class="tel" href="tel:+420775950328"><svg class="st"><use href="#star"/></svg>775 950 328</a>
  </div>
</nav>
...
<header class="hero" id="top">
  <div class="wrap hero-grid">
    <div>
      ...
      <div class="cta-row">
        <a class="btn btn-ink" href="#cena">Objednat vystoupení<svg class="st"><use href="#star"/></svg></a>
        <a class="btn btn-ghost" href="#disciplina">Prohlédnout program</a>
      </div>
...
<section class="gal-sec" id="galerie">
  <div class="wrap gal-head reveal">
    ...
    <p class="gal-hint">Táhněte<svg class="st"><use href="#star"/></svg></p>
  </div>
  <div class="strip" id="strip">
    <figure class="gph"><img src="/luxury/img-05.jpg" alt="Robin tvaruje balónek na pódiu"></figure>
    <figure class="gph"><img src="/luxury/img-06.jpg" alt="Robin s červeným balónkovým pudlem"></figure>
    <figure class="gph wide"><img src="/luxury/img-07.jpg" alt="Robin předvádí kouzelnou knihu dětem"></figure>
    <figure class="gph"><img src="/luxury/img-08.jpg" alt="Robin s loutkou mývala"></figure>
    <figure class="gph"><img src="/luxury/img-09.jpg" alt="Kouzelnický trik s barevnými šátky"></figure>
    <figure class="gph"><img src="/luxury/img-10.jpg" alt="Kouzelnický trik s míčky"></figure>
    <figure class="gph"><img src="/luxury/img-11.jpg" alt="Robin s balónkovým pejskem"></figure>
  </div>
</section>
...
<section class="trick" id="kouzlo">
  <div class="wrap">
    ...
    <div class="trick-ctas reveal d2">
      <button class="btn btn-amber" id="tbtn">Zamíchat karty<svg class="st"><use href="#star"/></svg></button>
    </div>
  </div>
</section>
  ...
  <div class="wrap">
    ...
    <div class="ticket reveal d1">
      ...
      <div class="tk-side">
        ...
        <div class="amt">3 500 <small>Kč</small></div>
        <span class="per">za vystoupení + doprava dle vzdálenosti</span>
