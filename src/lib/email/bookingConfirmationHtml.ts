...
function formatMoneyCzk(n: number) {
...
export function buildBookingConfirmationHtml(booking: Booking): string {
  ...
  const paid = formatMoneyCzk(booking.chargedAmountCzk);
        ...
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(26,26,26,0.06);">
          <tr>
            <td style="padding:28px 32px 8px 32px;border-bottom:1px solid rgba(184,150,62,0.25);">
              ...
              <h1 style="margin:12px 0 0 0;font-size:22px;font-weight:300;letter-spacing:-0.02em;">Rezervace je potvrzená</h1>
            </td>
          </tr>
          <tr>
            <td style="padding:24px 32px;">
              ...
              <p style="margin:0 0 20px 0;font-size:15px;line-height:1.65;color:${muted};">
                děkujeme za úhradu. Vaše rezervace u ${brand} je zapsaná a platba byla přijata.
              </p>
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#faf9f6;border-radius:12px;border:1px solid rgba(184,150,62,0.2);">
                <tr>
                  <td style="padding:18px 20px;">
                    ...
                    <p style="margin:14px 0 0 0;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:${muted};">Úhrada online</p>
                    <p style="margin:4px 0 0 0;font-size:15px;color:${accent};font-weight:600;">${paid}</p>
                  </td>
                </tr>
              </table>
              <p style="margin:22px 0 0 0;font-size:14px;line-height:1.6;color:${muted};">
                Zbytek doplatku dle ceníku probíhá v den návštěvy (hotově nebo kartou), pokud se domluvíme jinak — upřesníme u vás na místě.
              </p>
              <p style="margin:18px 0 0 0;font-size:14px;line-height:1.6;color:${muted};">
                Máte dotaz? Napište na <a href="mailto:${site.email}" style="color:${accent};text-decoration:none;border-bottom:1px solid rgba(184,150,62,0.4);">${site.email}</a>.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:18px 32px 28px 32px;background:#fafafa;border-top:1px solid #eee;">
              <p style="margin:0;font-size:12px;line-height:1.5;color:#888;">
                Tento e-mail byl odeslán automaticky po úspěšné platbě. Storno: dle obchodních podmínek na webu.
              </p>
            </td>
          </tr>
        </table>
