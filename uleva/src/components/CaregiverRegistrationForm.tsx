...
export function CaregiverRegistrationForm() {
  ...
  return (
    <div id="registrace" className="scroll-mt-28">
      <div className="max-w-2xl">
        <p className="eyebrow">Registrace</p>
        <h2 className="display mt-2 text-3xl md:text-4xl">Vyplňte přihlášku</h2>
        <p className="mt-3 text-ink-soft">
          4 kroky: údaje → služby → kalendář → doklady. Profil zveřejníme až po
          ověření.
        </p>
      </div>
